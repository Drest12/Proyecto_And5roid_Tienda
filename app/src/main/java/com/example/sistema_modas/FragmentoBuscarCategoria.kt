...
class FragmentoBuscarCategoria : Fragment() {
    ...
    private lateinit var btnHabilitarCat: Button
    private lateinit var btnDeshabilitarCat: Button
    ...
    override fun onCreateView(
        ...
        btnHabilitarCat=raiz.findViewById(R.id.btnHabilitarCat)
        btnDeshabilitarCat=raiz.findViewById(R.id.btnDeshabilitarCat)
        ...
        txtBusCat.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                (lstCat.adapter as AdaptadorBusquedaCategoria).filter(newText ?: "")
                return true
            }
        })
        ...
        call!!.enqueue(object : Callback<List<Categoria>?> {
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    lstCat.adapter= AdaptadorBusquedaCategoria(context,registroCategoria)
